...
export const schemaMap: Record<string, string> = {
  hero: 'modules/hero.ts',
  features: 'modules/features.ts',
  'logo-cloud': 'modules/logo-cloud.ts',
  'product-comparison': 'modules/productComparison.ts',
  'pricing-comparison': 'modules/pricing-comparison.ts',
  team: 'modules/team.ts',
  'pricing-list': 'modules/pricing-list.ts',
  'accordion-list': 'modules/accordion-list.ts',
  callout: 'modules/callout.ts',
  richtext: 'modules/text.ts',
  videoHero: 'modules/video-hero.ts',
  breadcrumbs: 'modules/breadcrumbs.ts',
  'component-gallery': 'modules/component-gallery.ts',
  'blog-frontpage': 'modules/blog-frontpage.ts',
  'latest-articles': 'modules/latest-articles.ts',
