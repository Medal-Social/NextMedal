    ...
    <div className="flex h-14 items-center justify-between">
      ...
      <div className="no-scrollbar flex flex-1 items-center space-x-6 overflow-x-auto pr-4">
        <button
          ...
          className={cn(
            'whitespace-nowrap border-b-2 py-4 font-bold text-xs uppercase tracking-wide transition-colors',
            category === 'All'
      ...
      {/* View Toggle and RSS */}
      <div className="flex items-center space-x-4 border-slate-200 border-l bg-white pl-4 md:bg-transparent dark:border-slate-700 dark:bg-[#0f172a]">
