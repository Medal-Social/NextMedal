...
export default async function ArticleFilterBar({
  ...
  return (
    <section className="sticky top-[var(--header-height)] z-40 border-slate-200 border-b bg-white/95 backdrop-blur-sm transition-all dark:border-slate-800 dark:bg-[#0f172a]/95">
